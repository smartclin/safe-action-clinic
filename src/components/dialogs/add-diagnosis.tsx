...
export const AddDiagnosis = ({ patientId, appointmentId, doctorId, medicalId }: AddDiagnosisProps) => {
        ...
        <Dialog>
            ...
            <DialogContent className='sm:max-w-[60%] 2xl:max-w-[40%]'>
                <CardHeader className='px-0'>
                    ...
                    <CardDescription>
                        Ensure accurate findings are presented and corrected accordingly to ensure that they are correct
                        for your application and that they do not result in an error.
                    </CardDescription>
                </CardHeader>
